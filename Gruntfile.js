module.exports = function(grunt) {
  ...
  this.registerTask('dist', "Builds a distributable version of composable component",
                    ['jshint',
                     'build',
  ...
  this.registerTask('build', "Builds a composable component",
                    ['clean',
                     'transpile:amd',
  ...
  grunt.initConfig({
    ...
    concat_sourcemap: {
      amd: {
        files: [{
          src: ['tmp/ember-composable-component.js', 'tmp/ember-composable-component/**/*.js', 'tmp/vendor/*.js'],
          dest: 'tmp/ember-composable-component.amd.js'
        }]
      },
      tests: {
        files: [{
    ...
    fix_sourcemap: {
      amd: {
        files: {
          src: 'tmp/ember-composable-component.amd.js.map'
        }
      },
      tests: {
        files: {
